...
export default function PolicyPage() {
  ...
  const sections = [
    ...
    { id: 'compensation-hour', title: 'Compensation and Hour Policies' },
    { id: 'performance-discipline', title: 'Performance, Discipline, Layoff, and Termination' },
    { id: 'general-policies', title: 'General Policies' },
    { id: 'safety-loss-prevention', title: 'Safety and Loss Prevention' },
    { id: 'trade-secrets', title: 'Trade Secrets and Inventions' },
    { id: 'closing-statement', title: 'Closing Statement' },
  ]
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1 max-w-4xl">
            <div className="bg-white border-2 border-brand-gray rounded-lg p-8 md:p-12 shadow-lg">
              ...
              <section id="hiring-orientation" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-4">
                      <h4 className="text-lg font-bold text-brand-black mb-2">Requesting a Religious Accommodation</h4>
                      <p>
              ...
              {/* Compensation and Hour Policies Section */}
              <section id="compensation-hour" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">4.1 Attendance</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">4.2 Business & Travel Expenses</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">4.3 Direct Deposit</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">4.6 Compensation Deductions</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">4.7 Recording Hours</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">4.10 Workday/Workweek</h3>
                    <p>
              ...
              {/* Performance, Discipline, Layoff, and Termination Section */}
              <section id="performance-discipline" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">5.1 Criminal Activity/Arrests</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">5.2 Penalties (fines) and disciplinary Process</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">5.5 Open Door/Conflict Resolution Process</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">5.11 Standards of Conduct</h3>
                    <p>
              ...
              <section id="general-policies" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.1 Authorization for Use of Personal Vehicle</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.3 Computer Security and Copying of Software</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.5 Employer Sponsored Social Events</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.7 Nonsolicitation/Nondistribution Policy</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.8 Off-Duty Use of Employer Property or Premises</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.9 Personal Appearance – REVIEW IN DETAIL</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.10 Personal Cell Phone/Mobile Device Use</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.11 Personal Data Changes</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.12 Security</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.13 Social Media</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.14 Suggestion Policy</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.16 Telephone Use</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.17 Third Party Disclosures</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.18 Use of Company Technology</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">6.19 Use of Employer Vehicles</h3>
                    <p>
              ...
              {/* Safety and Loss Prevention Section */}
              <section id="safety-loss-prevention" className="mb-12 scroll-mt-24">
                <h2 className="text-2xl md:text-3xl font-bold text-brand-black mb-4 border-b-2 border-brand-gold pb-2">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">8.1 Drug and Alcohol Policy</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">8.2 Drug-Free Workplace (Federal Contractors)</h3>
                    ...
                    <div className="mt-4">
                      ...
                      <p>
                        The Company will evaluate its obligations in accordance with state and other applicable laws where required, on a case by case basis.
                      </p>
                    </div>
                  </div>

                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">8.3 General Safety</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">8.4 Workplace Tobacco Usage</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">8.5 Workplace Violence</h3>
                    <p>
              ...
              {/* Trade Secrets and Inventions Section */}
              <section id="trade-secrets" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">9.1 Confidentiality and Nondisclosure of Trade Secrets</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">9.2 Inventions</h3>
                    <p>
              ...
              <section id="closing-statement" className="mb-12 scroll-mt-24">
                <h2 className="text-2xl md:text-3xl font-bold text-brand-black mb-4 border-b-2 border-brand-gold pb-2">
