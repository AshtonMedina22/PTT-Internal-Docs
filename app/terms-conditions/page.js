...
export default function TermsConditionsPage() {
  ...
  const sections = [
    { id: 'engagement-services', title: 'Engagement of Services' },
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1 max-w-4xl">
            <div className="bg-white border-2 border-brand-gray rounded-lg p-8 md:p-12 shadow-lg">
              ...
              {/* Engagement of Services Section */}
              <section id="engagement-services" className="mb-12 scroll-mt-24">
              ...
              <section id="independent-contractor-status" className="mb-12 scroll-mt-24">
                <h2 className="text-2xl md:text-3xl font-bold text-brand-black mb-4 border-b-2 border-brand-gold pb-2">
              ...
              {/* Confidentiality and Non-Disparagement Section */}
              <section id="confidentiality" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">a. Definition of Confidential Information</h3>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">b. Event-Specific Confidentiality</h3>
                    ...
                    <p>
                      Contractor may not share, post, or distribute any such information through social media, messaging apps, word-of-mouth, or any other means, unless explicitly authorized in writing.
                    </p>
                  </div>

                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">c. Obligations</h3>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">d. Exclusions</h3>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">e. Non-Disparagement</h3>
                    ...
                    <p>
                      This restriction does not prevent Contractor from making truthful statements required by law, subpoena, or legal proceeding.
                    </p>
                  </div>

                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">f. Injunctive Relief</h3>
                    <p>
                    ...
                    <p>
                      This section shall survive the termination or expiration of this Agreement indefinitely.
                    </p>
                  </div>
                </div>
              </section>

              {/* Non-Solicitation and Non-Circumvention Section */}
              <section id="non-solicitation" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">a. Definition of Affiliates</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">b. Acknowledgment and Reasonableness</h3>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">c. Remedies and Injunctive Relief</h3>
                    <p>
                    ...
                    <p>
                      This provision shall survive the termination or expiration of this Agreement for a period of twelve (12) months.
                    </p>
                  </div>
                </div>
              </section>

              {/* Ownership of Work Product Section */}
              <section id="work-product" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">a. Exclusions</h3>
              ...
              <section id="representations" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  ...
                  <p>
                    These representations and warranties shall survive the termination or expiration of this Agreement.
                  </p>
                </div>
              </section>
              ...
              {/* Precedence of Work Orders Section */}
              <section id="precedence" className="mb-12 scroll-mt-24">
                <h2 className="text-2xl md:text-3xl font-bold text-brand-black mb-4 border-b-2 border-brand-gold pb-2">
                  10. Precedence of Work Orders
                </h2>
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  <p>
              ...
              <section id="miscellaneous" className="mb-12 scroll-mt-24">
                ...
                <div className="prose prose-lg max-w-none text-brand-black leading-relaxed space-y-4">
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">Governing Law and Jurisdiction</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">Entire Agreement</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">Amendments and Waivers</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">Severability</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">Assignment</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">No Third-Party Beneficiaries</h3>
                    <p>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-brand-black mb-3">Force Majeure</h3>
                    <p>
